...
import { getTutorSessions } from '../api/api';
  ...
  if (!user || user.role !== 'tutor') {
    return (
      <div className="p-6 text-center text-gray-700">
        ...
        <p>Please log in as a tutor to view your sessions.</p>
      </div>
    );
  }
            ...
            <Card key={session._id} className="p-6 border border-gray-200">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="text-gray-600">Student: {session.studentId?.name || 'Unknown Student'}</p>
